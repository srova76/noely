...
<body>
    ...
    <section class="container">
        ...
        <legend><i class="fa fa-star"></i>&nbsp;Top 5 des cadeaux les plus demandés</legend>
            ...
            <?php
                $k=1;
                foreach($top5 as $top => $t){
                    echo("<tr>");
                    echo("<td>".$k."</td>");
                    echo("<td>".$t["idCadeau"]."</td>");
                    echo("<td width=5%'><img src='../images/cadeau/".$t["image"].".jpg' class='img-thumbnail'></td>");
                    echo("<td>".$t["nomCadeau"]."</td>");
                    echo("<td>".$t["nombre"]."</td>");
                    echo("</tr>\n");
                    $k++;
                }
