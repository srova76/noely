...
<head>
    ...
    <title>Dadabe Noely - Liste produit</title>
</head>
<body>
    ...
    <div class="container text-center row">
        <form class="form-horizontal" method="POST" action="produit.php">
            Catégorie:&nbsp;
    ...
    if (isset($_POST["recherche"])) {
        switch ($_POST["condition"]) {
            case "Nom":
                $critere.=" nomCadeau LIKE '%".$_POST['inputRecherche']."%'";
                $order="nomCadeau ASC";
                break;
        ...
        if ($_POST["categorie"]!="0"){
            ...
            $c=" c.idCategorie=k.idCategorie AND k.nomCategorie='".$_POST['categorie']."'";
    ...
    echo("
        <section class='cadeau container thumbnail col-lg-6 col-md-6 col-sm-6'>
            ...
            <div class='col-md-8 col-sm-8 col-xs-8'> 
                ...
                <a href='modifierproduit.php?id=".$cadeau["idCadeau"]."' title='Modifier le produit' class='annuler'><i class='fa fa-edit fa-2x'></i></i></a>        
                <a href='#cadeau".$cadeau["idCadeau"]."' title='Supprimer le produit' data-toggle='collapse' class='annuler'><i class='fa fa-trash fa-2x'></i></i></a>        
                <div id='cadeau".$cadeau["idCadeau"]."' class='collapse'>
                    Supprimer le produit?
                    <a href='supprimerproduit.php?id=".$cadeau["idCadeau"]."' title='Valider' class='ajouter'><i class='fa fa-check'></i></a>
