...
<head>
    ...
    <title>Dadabe Noely - Connexion</title>
</head>
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="connexion.php"><span class="fa fa-sign-in"></span>&nbsp;Connexion</a></li>
        ...
        <div class="col-md-6 col-sm-6">
            <form class="form-signin" method="POST" action="testconnexion.php">
                ...
                <div class="form-group">
                    ...
                    <input name="inputmail" id="inputmail" type="text" class="form-control" placeholder="Adresse e-mail" required>
                </div>
                <div class="form-group">
